...
<div class="w-full">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between pb-4 border-b">
        ...
        <div class="flex flex-wrap items-center space-x-3">
            {{-- Tombol Tambah --}}
            <a href="{{ route('create-surat-masuk') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 flex items-center mb-2 md:mb-0">
        ...
        <table class="w-full border-collapse divide-y divide-gray-200">
            <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-2 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">No Agenda</th>
                        <th class="px-2 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tanggal Diterima</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2021-08-10</td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-center space-x-1">
                            <a href="{{ route('show-surat-masuk') }}" class="inline-flex items-center px-3 py-1 bg-green-500 text-white text-xs font-bold rounded hover:bg-green-600 transition">View</a>
                            <a href="{{ route('edit-surat-masuk') }}" class="inline-flex items-center px-3 py-1 bg-yellow-500 text-white text-xs font-bold rounded hover:bg-yellow-600 transition">Edit</a>
