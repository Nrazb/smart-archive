...
<div class="w-full">
    ...
    <div class="flex flex-col md:flex-row items-start md:items-center justify-between pb-4 border-b">
        ...
        <div class="flex flex-wrap items-center space-x-3">
            {{-- Tombol Tambah --}}
            <a href="{{ route('letters.create') }}" class="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded-lg shadow-md transition duration-300 flex items-center mb-2 md:mb-0">
